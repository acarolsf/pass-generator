...
enum LocalizationKeys {
    ...
    static let tipTwoText = "tip_two_text"
    static let tipThreeTitle = "tip_three_title"
    static let tipThreeText = "tip_three_text"
    static let tipFourTitle = "tip_four_title"
    static let tipFourText = "tip_four_text"
}
